...
export default async function StudentDiscussionsPage() {
  ...
  return (
    <div className="space-y-8 pb-10">
      <header>
        <h1 className="text-3xl font-black text-slate-900 tracking-tight">Discussions</h1>
        <p className="text-slate-500 font-medium">Join conversations and get help from your peers and lecturers.</p>
      </header>
          ...
          >
            ...
            <div className="mt-6 pt-4 border-t border-slate-50">
              <p className="text-sm font-semibold text-slate-600">
                {e.course._count.threads} active threads
              </p>
            </div>
          </Link>
        ))}
